				...
				<?php } ?>
					...
					<li class="dropdown <?php if (in_array($this->uri->segment(1), array('user', 'offers'))) { ?>active<?php } ?>">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="<?php echo base_url('/offers/sent') ?>">Sent Offers <span class="badge badge-info" style="background-color: red; float: right;"><?php if($sent_offer_notification>0){echo $sent_offer_notification ;} ?></span></a></li>
							<li><a href="<?php echo base_url('/offers/received') ?>">Received Offers <span class="badge badge-info" style="background-color: red; float: right;"><?php if($received_offer_notification>0){echo $received_offer_notification ;} ?></span></a></li>
