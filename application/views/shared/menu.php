				...
				<?php } ?>
					...
					<li class="dropdown <?php if (in_array($this->uri->segment(1), array('user', 'offers'))) { ?>active<?php } ?>">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="<?php echo base_url('/offers/sent') ?>"><pre>Sent Offers       </pre><span class="badge badge-info" style="background-color: red;"><?php if($sent_offer_notification>0){echo $sent_offer_notification ;} ?></span></a></li>
