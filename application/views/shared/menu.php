<?php 
	...
	$sent_offer_notification = $this->offer_model->get_buyer_pending_offers_count($user);
	$received_offer_notification = $this->offer_model->get_seller_pending_offers_count($user);
?>
