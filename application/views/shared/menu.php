			...
			<ul class="nav navbar-nav navbar-right">
				...
				<?php if($this->ion_auth->is_admin()){?>
					...
					<li class="dropdown <?php if (in_array($this->uri->segment(1), array('auth', 'admin'))) { ?>active<?php } ?>">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">Admin <span class="badge badge-info"><?php if($flag_notification>0){echo $flag_notification ;} ?></span><b class="caret"></b></a>
						<ul class="dropdown-menu">
							<li><a href="<?php echo base_url('/admin/manage_flags') ?>">Manage Flags &nbsp <span class="badge badge-info"><?php if($flag_notification>0){echo $flag_notification ;} ?></span></a></li>
				...
				<?php } ?>
					...
					<li class="dropdown <?php if (in_array($this->uri->segment(1), array('user', 'offers'))) { ?>active<?php } ?>">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo $user->first_name; ?> <span class="badge badge-info"><?php if($total_offer_notification>0){echo $total_offer_notification ;} ?></span> <b class="caret"></b></a>
						<ul class="dropdown-menu">
							<li><a href="<?php echo base_url('/ad/user_ads') ?>">My Ads</a></li>
							<li><a href="<?php echo base_url('/offers/sent') ?>">Sent Offers <span class="badge badge-info"><?php if($sent_offer_notification>0){echo $sent_offer_notification ;} ?></span></a></li>
							<li><a href="<?php echo base_url('/offers/received') ?>">Received Offers <span class="badge badge-info"><?php if($received_offer_notification>0){echo $received_offer_notification ;} ?></span></a></li>
