				...
				<?php if($this->ion_auth->is_admin()){?>
					...
					<li class="dropdown <?php if (in_array($this->uri->segment(1), array('auth', 'admin'))) { ?>active<?php } ?>">
						...
						<ul class="dropdown-menu">
							<li><a href="<?php echo base_url('/admin/manage_flags') ?>">Manage Flags  <span class="badge badge-info" style="background-color: red;"><?php echo $flag_notification ?></span></a></li>
