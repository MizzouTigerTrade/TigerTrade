...
<div class="container padding-top-20">
	...
	<button type="button" id="pending_button" class="btn btn-default btn-warning offers-button">Pending <span class="badge badge-info" style="background-color: #D43F3A;"><?php if($offer_notification>0){echo $received_offer_notification ;} ?></span></button> <button type="button" id="accepted_button" class="btn btn-default offers-button">Accepted</button> <button type="button" id="declined_button" class="btn btn-default offers-button">Declined</button>
	<br>
	<br>
