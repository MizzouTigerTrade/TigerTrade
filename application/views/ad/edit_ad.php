					...
					<div class="col-sm-10">
						<div id="filediv">
							<div id="abcd<?= $inc ?>" class="abcd">
								...
								<img id="img" src="https://cdn3.iconfinder.com/data/icons/flatforlinux/256/24-Empty%20Trash.png" alt=" delete" onclick="$(this).parent().parent().remove();deleteImage(<?php echo $img->tag_id; ?>);"></img>
							</div>
						</div>
					</div>
				</div>
